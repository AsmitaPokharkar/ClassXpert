...
-  **Tailwind CSS** with custom theming (light/dark mode support)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/your-username/unified-learning-platform.git
   cd unified-learning-platform
   ```
